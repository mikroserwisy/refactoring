...
class SearchProductsServiceTests {
    ...
    private final Product product = new Product(1L, "Some product", false);
    ...
    void given_a_products_with_keywords_when_search_then_returns_scores_sorted_by_value_in_descending_order() {
        var secondProduct = new Product(2L, "Some product and product", false);
        when(productQueries.getAll()).thenReturn(List.of(product, secondProduct));
